...
import { ArrowLeft, Send, MessageCircle, LogIn } from "lucide-react";
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="flex flex-col items-center justify-center py-32 gap-4 px-4 text-center">
          ...
          <p className="text-muted-foreground max-w-sm">
            {lang === "ar"
              ? "سجل الدخول للتواصل مع البائعين والمشترين"
              : "Sign in to connect with buyers and sellers"}
          </p>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 text-start">
                          ...
                          <div className="flex items-center justify-between gap-2">
                            ...
                            {conv.unread_count > 0 && (
                              <span className="flex h-5 min-w-5 items-center justify-center rounded-full bg-primary text-primary-foreground text-[10px] font-bold px-1.5 shrink-0">
                                {conv.unread_count}
                              </span>
                            )}
                          </div>
      ...
      <div className="flex items-center gap-3 p-4 border-b border-border">
        ...
        <div className="min-w-0">
          ...
          {conversation?.listing_title && (
            <p className="text-xs text-primary truncate">{conversation.listing_title}</p>
          )}
        </div>
      </div>
