  ...
  return (
    <section className="py-6 bg-muted/40 border-b border-border">
      <div className="container">
        <div className="flex items-center gap-4 overflow-x-auto pb-2 scrollbar-none md:grid md:grid-cols-5 md:gap-3 md:overflow-visible md:pb-0">
          {categories.map((cat) => {
            const Icon = cat.icon;
            return (
              <button
                ...
                className="group flex flex-col items-center gap-2 shrink-0 min-w-[68px] px-2 py-3 rounded-xl border-2 border-transparent transition-all hover:border-primary hover:scale-105"
